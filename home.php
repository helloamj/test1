...
<path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"/>
  ...
  <li><a class="dropdown-item" href="http://localhost/WeBlog-main/suggestion box.php">Suggestions</a></li>
    ...
    <div class="container">
<button class="btn btn-success"style="position: absolute; left: 47%; top:17%;"><a href="TEXTAPP/texteditor.php" style="text-decoration: dashed; color: white;">+ Create </a></button>
<!-- 
